...
# Get the root directory (parent of app directory, which is api/ or backend/)
# This ensures .env file is found regardless of where uvicorn is started from
# For Vercel: api/app/config.py -> api/.env
# For local dev: backend/app/config.py -> backend/.env
